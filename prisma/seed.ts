    ...
    const pizzaProducts = [
      {
        ...
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/e49d8e21-ace5-4803-bd1e-4dc8cd1712b1-berpu3.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/3b1fed03-3d45-4c68-8bfd-7affccaeee9e-berpu4.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/39af18ac-ddbc-4e94-bfba-8d411ee2a823-berpu5.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/88620dce-1d5f-4f0b-b8f1-d268c48eecd9-berpu7.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/e26ec412-360b-4432-98b5-1a2557de3fa3-berpu8.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
    ...
    const brazilianProducts = [
      {
        ...
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/721392f0-93bd-46ea-985c-f5da35db706d-xf34pf.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        description: 'A delicious picanha',
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/e51743ed-50b3-4d88-ba9f-eb824661f3a7-xf34pe.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        description: 'A delicious picanha',
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/cfb51851-535d-4dd9-9029-82a240cafac1-xf34pd.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        description: 'A delicious picanha',
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/3e1abeeb-46cc-4ad2-89db-a136f2f9ae66-xf34pc.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        description: 'A delicious picanha',
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/5d9118c2-8fb1-4753-88f6-432a6a4a9a16-xf34pb.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
      ...
      },
      {
        ...
        description: 'A delicious picanha',
        discountPercentage: 0,
        imageUrl: 'https://utfs.io/f/65bdc9db-f58e-409e-92f0-a40f3946f8b9-xf34pa.png',
        restaurant: {
          connect: {
            id: restaurant.id,
          },
